...
export function StarRanking() {
  ...
  return (
    <StarRankingContainer>
      <StarButton
        id={1}
        isHover={valueStarHover >= 1 && assessmentValue >= valueStarHover}
        type="button"
        onClick={() => {
          handleAssessment(1)
        }}
      ...
      <StarButton
        isHover={valueStarHover >= 2 && assessmentValue >= valueStarHover}
        type="button"
        onClick={() => {
          handleAssessment(2)
        }}
      ...
      <StarButton
        isHover={valueStarHover >= 3 && assessmentValue >= valueStarHover}
        type="button"
        onClick={() => {
          handleAssessment(3)
        }}
      ...
      <StarButton
        isHover={valueStarHover >= 4 && assessmentValue >= valueStarHover}
        type="button"
        onClick={() => {
          handleAssessment(4)
        }}
      ...
      <StarButton
        isHover={valueStarHover >= 5 && assessmentValue >= valueStarHover}
        type="button"
        onClick={() => {
          handleAssessment(5)
        }}
